    ...
    <div class="navbar-fixed">
        <nav>
            ...
            <div class="container">
                <div class="row">
                    <br>
                    <div class="col s6"><div class="card-panel">
                        <i class="material-icons left medium green circle lighten-2">attach_money</i>
                        <span class="card-title boldText">TODAY INCOME</span>
                        <p>0</p>
                    </div></div>
                    <div class="col s6"><div class="card-panel">
                        <i class="material-icons left medium red circle lighten-2">face</i>
                        <span class="card-title boldText">TOTAL CUSTOMERS</span>
                        <p>0</p>
                    </div></div>
                </div>
                <div class="row">
                    <div class="col s6"><div class="card-panel">
                            <i class="material-icons left medium cyan circle lighten-2">insert_invitation</i>
                            <span class="card-title boldText">TODAY APPOINTMENTS</span>
                            <p>0</p>
                    </div></div>
                    <div class="col s6"><div class="card-panel">
                            <i class="material-icons left medium yellow circle lighten-2">priority_high</i>
                            <span class="card-title boldText">REPORTS</span>
                            <p>0</p>
                    </div></div>
