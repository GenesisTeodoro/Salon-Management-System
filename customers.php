<?php require_once 'customersProcess.php'; ?>
                    ...
                    <div class="container">
                        <form class="col s12" action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <?php
                                if($update == true): ?>
                                    <button onclick="M.toast({html: 'Record has been updated', displayLength: 2000})" class="btn" type="submit" name="update">Update</button>
                                <?php else: ?>
                                    <button onclick="M.toast({html: 'Record has been saved', displayLength: 2000})" class="btn" type="submit" name="save">Save</button>
                                <?php endif; ?>
                        ...
                        <table>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn" href="customers.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                        <a onclick="M.toast({html: 'Record has been deleted', displayLength: 2000})" class="btn" href="customersProcess.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                        </table>
