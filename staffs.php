<?php require_once 'staffsProcess.php'; ?>
        ...
        <nav>
            ...
            <?php ?>
                    <?php
                        ...
                        $result = $mysqli->query("SELECT * FROM staffs") or die($mysqli->error);
                        //pre_r($result);?>
                    <br><br>
                    <div class="container">
                        <form class="col s12" action="" method="POST">
                            <div class="row">
                                ...
                                <div class="col s6">
                                    ...
                                    <input type="text" name="staffName" placeholder="Enter Staff Name" 
                                        value="<?php echo $staffName;?>" required>
                                </div>
                                <div class="col s3">
                                    <label>Age</label>
                                ...
                                <div class="col s3">
                                    <label>Gender</label>
                                    <input type="text" name="gender" placeholder="Enter Age"
                            ...
                            <div class="row">
                                ...
                                <?php
                                if($update == true): ?>
                                    <button onclick="M.toast({html: 'Staff Updated', displayLength: 2000})" class="btn" type="submit" name="update">Update</button>
                                <?php else: ?>
                                    <button onclick="M.toast({html: 'Staff Saved', displayLength: 2000})" class="btn" type="submit" name="save">Save</button>
                                <?php endif; ?>
                        ...
                        <table>
                            ...
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn" href="staffs.php?edit=<?php echo $row['id']; ?>">Edit</a>
                                        <a onclick="M.toast({html: 'Staff Deleted', displayLength: 2000})" class="btn" href="staffsProcess.php?delete=<?php echo $row['id']; ?>">Delete</a>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
                        </table>
